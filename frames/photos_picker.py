...
class PhotosPickerFrame(tk.LabelFrame):
    def __init__(self, parent, *args, **kwargs):
        ...
        # choose directory
        self.radio_dir = tk.Radiobutton(
            self, variable=self.img_or_dir, value="dir", command=self.switch_img_or_dir
        )
        ...
        self.radio_img = tk.Radiobutton(
            self, variable=self.img_or_dir, value="img", command=self.switch_img_or_dir
        )
        ...
        self.img_button = tk.Button(
            self, text="Pick photo", command=self.select_photo, state=tk.DISABLED
        )
